...
import componentStyle from './know-what-works-mobile.style';

gsap.registerPlugin(ScrollTrigger, drawSVG);

export function KnowWhatWorksMobile() {
  ...
  return (
    <section className="section">
      <div className="know_wrap know_wrap--v2_mod" ref={$block}>
        <svg
...
export default KnowWhatWorksMobile;
